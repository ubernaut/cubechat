...
import type { PeerDiscovery, PeerDiscoveryEvents, PeerId, Startable, ComponentLogger, TypedEventTarget } from '@libp2p/interface';
 ...
 */
export declare class PubSubPeerDiscovery extends TypedEventEmitter<PeerDiscoveryEvents> implements PeerDiscovery, Startable {
