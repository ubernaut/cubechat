...
`)}function qp(r,e){let t;switch(e){case jc:t="Linear";break;case $c:t="Reinhard";break;case Kc:t="Cineon";break;case Zc:t="ACESFilmic";break;case Qc:t="AgX";break;case eh:t="Neutral";break;case Jc:t="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",e),t="Linear"}return"vec3 "+r+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const Os=new H;function Yp(){je.getLuminanceCoefficients(Os);const r=Os.x.toFixed(4),e=Os.y.toFixed(4),t=Os.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${r}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
...
`)+`
`+f);const E=v+m+o,x=v+f+a,T=el(i,i.VERTEX_SHADER,E),A=el(i,i.FRAGMENT_SHADER,x);i.attachShader(_,T),i.attachShader(_,A),t.index0AttributeName!==void 0?i.bindAttribLocation(_,0,t.index0AttributeName):t.morphTargets===!0&&i.bindAttribLocation(_,0,"position"),i.linkProgram(_);function C(P){if(r.debug.checkShaderErrors){const B=i.getProgramInfoLog(_)||"",I=i.getShaderInfoLog(T)||"",O=i.getShaderInfoLog(A)||"",U=B.trim(),N=I.trim(),Y=O.trim();let V=!0,K=!0;if(i.getProgramParameter(_,i.LINK_STATUS)===!1)if(V=!1,typeof r.debug.onShaderError=="function")r.debug.onShaderError(i,_,T,A);else{const oe=nl(i,T,"vertex"),ue=nl(i,A,"fragment");console.error("THREE.WebGLProgram: Shader Error "+i.getError()+" - VALIDATE_STATUS "+i.getProgramParameter(_,i.VALIDATE_STATUS)+`
